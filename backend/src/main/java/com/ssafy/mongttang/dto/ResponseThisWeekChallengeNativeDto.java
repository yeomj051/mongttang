...
@Getter
@NoArgsConstructor
public class ResponseThisWeekChallengeNativeDto {
    ...
    private List<ResponseChallengeBookInfoNativeDto> bookList;

    public ResponseThisWeekChallengeNativeDto(Challenge challenge, List<ResponseChallengeBookInfoNativeDto> bookList) {
