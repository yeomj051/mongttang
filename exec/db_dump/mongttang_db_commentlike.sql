...
CREATE TABLE `commentlike` (
  ...
  `commentlike_user_id` int(11) NOT NULL,
  `commentlike_comment_id` int(11) NOT NULL,
  PRIMARY KEY (`commentlike_id`),
  KEY `FKh17aw72n8er5mdjaxskk38dlf` (`commentlike_comment_id`),
  CONSTRAINT `FKh17aw72n8er5mdjaxskk38dlf` FOREIGN KEY (`commentlike_comment_id`) REFERENCES `comment` (`comment_id`)
